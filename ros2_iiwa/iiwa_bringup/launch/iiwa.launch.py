...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'use_vision',
            default_value='false',
            description='Start robot with the camera being mounted.',
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
    ...
    """iiwa_simulation_world = PathJoinSubstitution(
        [FindPackageShare(description_package),
            'gazebo/worlds', 'empty_with_a_sphere.world']
    )"""

    """declared_arguments.append(DeclareLaunchArgument('gz_args', default_value='-r -v 1 arucotag.sdf',
